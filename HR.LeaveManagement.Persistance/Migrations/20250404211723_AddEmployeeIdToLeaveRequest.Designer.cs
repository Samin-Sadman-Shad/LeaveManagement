...
namespace HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20250404211723_AddEmployeeIdToLeaveRequest")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.Entities.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AllocatedDays = 10,
                            DateCreated = new DateTime(2025, 4, 5, 3, 17, 23, 245, DateTimeKind.Local).AddTicks(7625),
                        ...
                        new
                        {
                            Id = 2,
                            AllocatedDays = 14,
                            DateCreated = new DateTime(2025, 4, 5, 3, 17, 23, 245, DateTimeKind.Local).AddTicks(7641),
                        ...
                        new
                        {
                            Id = 3,
                            AllocatedDays = 15,
                            DateCreated = new DateTime(2025, 4, 5, 3, 17, 23, 245, DateTimeKind.Local).AddTicks(7643),
                        ...
                        new
                        {
                            Id = 4,
                            AllocatedDays = 10,
                            DateCreated = new DateTime(2025, 4, 5, 3, 17, 23, 245, DateTimeKind.Local).AddTicks(7644),
